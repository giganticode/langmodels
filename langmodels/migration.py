...
def pth_to_torch(old_weights: OrderedDict):
    ...
    new_weights['0.rnns.0.weight_hh_l0_raw']=old_weights['model']['0.rnns.0.weight_hh_l0_raw']
    new_weights['0.rnns.0.module.weight_ih_l0']=old_weights['model']['0.rnns.0.module.weight_ih_l0']
    new_weights['0.rnns.0.module.weight_hh_l0']=old_weights['model']['0.rnns.0.module.weight_hh_l0']
    new_weights['0.rnns.0.module.bias_ih_l0']=old_weights['model']['0.rnns.0.module.bias_ih_l0']
    new_weights['0.rnns.0.module.bias_hh_l0']=old_weights['model']['0.rnns.0.module.bias_hh_l0']
