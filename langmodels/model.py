...
class TrainedModel(object):
    ...
    def get_default_model(cls, force_use_cpu: bool = False) -> 'TrainedModel':
        return TrainedModel.get_medium_model(force_use_cpu)
    ...
    @classmethod
    def get_medium_model(cls, force_use_cpu: bool = False) -> 'TrainedModel':
        return TrainedModel.load_model_by_name(MEDIUM_MODEL_NAME, force_use_cpu)
